...
private:
   ...
   // Widgets::PushButton *_heartSSButton;
    ...
    void muscleSBProPressed(Widgets::MouseEvent *mouseEv, Widgets::PushButton* buttonInst);
    void neuronSBProPressed(Widgets::MouseEvent *mouseEv, Widgets::PushButton* buttonInst);
